...
def registrarion():
    ...
    registr_name = Entry(root, bd=2,fg='grey',relief='groove', width=22, font = FontOfEntryList,justify="center")
    registr_name.insert(0,"имя")    
    registr_name.bind('<Button-1>', click_name)
    # registr_surname = EntryWithPlaceholder(root, "фамилия")  
    registr_surname = Entry(root, bd=2,fg='grey',relief='groove', width=22, font = FontOfEntryList,justify="center")
    registr_surname.insert(0,"фамилия")    
    registr_surname.bind('<Button-1>', click_surname)
    
    registr_login = Entry(root, bd=2,fg='grey',relief='groove', width=22, font = FontOfEntryList,justify="center")
    registr_login.insert(0,"логин")    
    registr_login.bind('<Button-1>', click_login)
    
    registr_password1 = Entry(root, bd=2,fg='grey',relief='groove', width=22, font = FontOfEntryList,justify="center")
    registr_password1.insert(0,"пароль")    
    registr_password1.bind('<Button-1>', click_pass1)
    
    registr_password2 = Entry(root, bd=2,fg='grey',relief='groove', width=22, font = FontOfEntryList,justify="center")
    ...
    button_registr = Button(text="регистрация", bd=2, fg='dim grey', relief='groove', font = FontOfEntryList, background='#eeeded',  command=lambda:data_check())
...
def login():
    ...
    enter_login = Entry(root, bd=2,fg='grey',relief='groove', width=22, font = FontOfEntryList,justify="center")
    enter_login.insert(0,"логин")    
    enter_login.bind('<Button-1>', click_login_a)
            
    enter_password = Entry(root, bd=2,fg='grey',relief='groove', width=22, font = FontOfEntryList,justify="center")
    enter_password.insert(0,"пароль")
    enter_password.bind('<Button-1>', click_pass_a)
    
    button_enter = Button(text="вход", bd=2, fg='dim grey', relief='groove', font = FontOfEntryList, background='#eeeded',  command=lambda: log_pass())
    button_reg = Button(text="регистрация", background='#eeeded',bd=2, fg='light grey', relief='groove', font = FontOfEntryList, command=lambda: reg_open())
    c1 = Checkbutton(text="запомнить пароль", onvalue=1, offvalue=0, background='white', font = 'Calibri, 10', bd=1)
    forget_pass = Label(text="забыли пароль?", background='white', font = 'Calibri, 10')   
